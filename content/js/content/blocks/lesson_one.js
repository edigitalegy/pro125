...
function btn_one(button) {
  ...
  switch (button.id) {
      ...
      case "1act1": loadForm('https://forms.gle/Zs8mEhJSFRL9hMip7'); break;
      case "1act2": loadForm('https://forms.gle/oeZhRmnMZPiqrrSW7'); break;
      case "1act3": loadForm('https://forms.gle/8fwHB4VLX5pzFwgs9'); break;
