...
switch (button.id) {
  ...
  case "2act1": loadForm('https://forms.gle/ewHrvYk9zvrgLyXh7'); break;
  case "2act2": loadForm('https://forms.gle/ZJRuNJdFQrXJL5a39'); break;
  case "2act3": loadForm('https://forms.gle/vxZPFdTx4SkKqZANA'); break;
