...
import { btn_three } from './blocks/lesson_three.js';
import { btn_four } from './blocks/lesson_four.js';
import { btn_five } from './blocks/lesson_five.js';
import { btn_six } from './blocks/lesson_six.js';
...
const handleButtonClick = debounce((button) => {
  ...
  hiddenele();
    ...
    else if (button.id.charAt(0) === "3") {btn_three(button); foundelement(button)}
    else if (button.id.charAt(0) === "4") {btn_four(button);foundelement(button)}
    else if (button.id.charAt(0) === "5") {btn_five(button); foundelement(button)}
    else if (button.id.charAt(0) === "6") {btn_six(button);foundelement(button)}
  }, 300);
